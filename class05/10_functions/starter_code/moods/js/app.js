...
$(document).ready(function () {
    ...
    $("#submit-btn").click(function(e){
        ...
        if (moodvalue !== "excited" && moodvalue !== "ecstatic" && moodvalue !== "fantastic" && moodvalue !== "happy" && moodvalue !== "good" && moodvalue !== "great" && moodvalue !== "bad" && moodvalue !== "angry") {
            $(".moodring > div").attr("class","blank");
        }
    });
